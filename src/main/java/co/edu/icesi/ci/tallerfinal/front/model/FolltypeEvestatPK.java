...
public class FolltypeEvestatPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof co.edu.icesi.ci.tallerfinal.back.model.FolltypeEvestatPK)) {
			return false;
		}
		co.edu.icesi.ci.tallerfinal.back.model.FolltypeEvestatPK castOther = (co.edu.icesi.ci.tallerfinal.back.model.FolltypeEvestatPK)other;
		return 
