...
public class CheckMeasurPK implements Serializable {
	...
	@Column(name="PHYCHE_ID", insertable=false, updatable=false)
	private long phychePhycheId;

	@Column(name="MEAS_ID", insertable=false, updatable=false)
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof co.edu.icesi.ci.tallerfinal.back.model.CheckMeasurPK)) {
			return false;
		}
		co.edu.icesi.ci.tallerfinal.back.model.CheckMeasurPK castOther = (co.edu.icesi.ci.tallerfinal.back.model.CheckMeasurPK)other;
		return 
