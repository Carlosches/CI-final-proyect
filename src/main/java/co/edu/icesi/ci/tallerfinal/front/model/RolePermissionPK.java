...
public class RolePermissionPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof co.edu.icesi.ci.tallerfinal.back.model.RolePermissionPK)) {
			return false;
		}
		co.edu.icesi.ci.tallerfinal.back.model.RolePermissionPK castOther = (co.edu.icesi.ci.tallerfinal.back.model.RolePermissionPK)other;
		return 
