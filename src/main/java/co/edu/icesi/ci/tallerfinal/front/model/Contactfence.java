...
import co.edu.icesi.ci.tallerfinal.back.model.PersonFence;
import co.edu.icesi.ci.tallerfinal.back.model.Queuecreatefence;
import co.edu.icesi.ci.tallerfinal.back.model.Queuecreatefencehistory;
import co.edu.icesi.ci.tallerfinal.back.model.Queuedisablefence;
import co.edu.icesi.ci.tallerfinal.back.model.Queuedisablefencehistory;
...
public class Contactfence implements Serializable {
	...
	private co.edu.icesi.ci.tallerfinal.back.model.Contactfence contactfence;

	//bi-directional many-to-one association to Contactfence
	@OneToMany(mappedBy="contactfence")
	private List<co.edu.icesi.ci.tallerfinal.back.model.Contactfence> contactfences;
	...
	public co.edu.icesi.ci.tallerfinal.back.model.Contactfence getContactfence() {
		return this.contactfence;
	}

	public void setContactfence(co.edu.icesi.ci.tallerfinal.back.model.Contactfence contactfence) {
		this.contactfence = contactfence;
	}

	public List<co.edu.icesi.ci.tallerfinal.back.model.Contactfence> getContactfences() {
		return this.contactfences;
	}

	public void setContactfences(List<co.edu.icesi.ci.tallerfinal.back.model.Contactfence> contactfences) {
		this.contactfences = contactfences;
	}

	public co.edu.icesi.ci.tallerfinal.back.model.Contactfence addContactfence(co.edu.icesi.ci.tallerfinal.back.model.Contactfence contactfence) {
	...
	public co.edu.icesi.ci.tallerfinal.back.model.Contactfence removeContactfence(co.edu.icesi.ci.tallerfinal.back.model.Contactfence contactfence) {
