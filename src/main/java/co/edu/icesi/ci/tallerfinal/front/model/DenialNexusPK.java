...
public class DenialNexusPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof co.edu.icesi.ci.tallerfinal.back.model.DenialNexusPK)) {
			return false;
		}
		co.edu.icesi.ci.tallerfinal.back.model.DenialNexusPK castOther = (co.edu.icesi.ci.tallerfinal.back.model.DenialNexusPK)other;
		return 
