...
public class PermFolltypePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof co.edu.icesi.ci.tallerfinal.back.model.PermFolltypePK)) {
			return false;
		}
		co.edu.icesi.ci.tallerfinal.back.model.PermFolltypePK castOther = (co.edu.icesi.ci.tallerfinal.back.model.PermFolltypePK)other;
		return 
