...
public class PersonVulnerPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof co.edu.icesi.ci.tallerfinal.back.model.PersonVulnerPK)) {
			return false;
		}
		co.edu.icesi.ci.tallerfinal.back.model.PersonVulnerPK castOther = (co.edu.icesi.ci.tallerfinal.back.model.PersonVulnerPK)other;
		return 
