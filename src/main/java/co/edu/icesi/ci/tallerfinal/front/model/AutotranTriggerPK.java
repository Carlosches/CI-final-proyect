...
public class AutotranTriggerPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof co.edu.icesi.ci.tallerfinal.back.model.AutotranTriggerPK)) {
			return false;
		}
		co.edu.icesi.ci.tallerfinal.back.model.AutotranTriggerPK castOther = (co.edu.icesi.ci.tallerfinal.back.model.AutotranTriggerPK)other;
		return 
