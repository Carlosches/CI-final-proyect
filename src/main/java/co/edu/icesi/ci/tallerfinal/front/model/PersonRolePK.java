...
public class PersonRolePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof co.edu.icesi.ci.tallerfinal.back.model.PersonRolePK)) {
			return false;
		}
		co.edu.icesi.ci.tallerfinal.back.model.PersonRolePK castOther = (co.edu.icesi.ci.tallerfinal.back.model.PersonRolePK)other;
		return 
