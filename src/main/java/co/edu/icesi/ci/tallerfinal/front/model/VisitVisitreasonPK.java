...
public class VisitVisitreasonPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof co.edu.icesi.ci.tallerfinal.back.model.VisitVisitreasonPK)) {
			return false;
		}
		co.edu.icesi.ci.tallerfinal.back.model.VisitVisitreasonPK castOther = (co.edu.icesi.ci.tallerfinal.back.model.VisitVisitreasonPK)other;
		return 
