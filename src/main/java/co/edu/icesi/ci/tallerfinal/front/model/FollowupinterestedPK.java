...
public class FollowupinterestedPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof co.edu.icesi.ci.tallerfinal.back.model.FollowupinterestedPK)) {
			return false;
		}
		co.edu.icesi.ci.tallerfinal.back.model.FollowupinterestedPK castOther = (co.edu.icesi.ci.tallerfinal.back.model.FollowupinterestedPK)other;
		return 
