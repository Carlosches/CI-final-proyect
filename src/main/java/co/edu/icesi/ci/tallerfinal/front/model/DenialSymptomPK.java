...
public class DenialSymptomPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof co.edu.icesi.ci.tallerfinal.back.model.DenialSymptomPK)) {
			return false;
		}
		co.edu.icesi.ci.tallerfinal.back.model.DenialSymptomPK castOther = (co.edu.icesi.ci.tallerfinal.back.model.DenialSymptomPK)other;
		return 
