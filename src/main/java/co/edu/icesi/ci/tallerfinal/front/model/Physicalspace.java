...
import co.edu.icesi.ci.tallerfinal.back.model.Communityinstance;
import co.edu.icesi.ci.tallerfinal.back.model.HatCapacitydetail;
import co.edu.icesi.ci.tallerfinal.back.model.Institutioncampus;
import co.edu.icesi.ci.tallerfinal.back.model.Physicalspacetype;
...
public class Physicalspace implements Serializable {
	...
	private co.edu.icesi.ci.tallerfinal.back.model.Physicalspace physicalspace;

	//bi-directional many-to-one association to Physicalspace
	@OneToMany(mappedBy="physicalspace")
	private List<co.edu.icesi.ci.tallerfinal.back.model.Physicalspace> physicalspaces;
	...
	public co.edu.icesi.ci.tallerfinal.back.model.Physicalspace getPhysicalspace() {
		return this.physicalspace;
	}

	public void setPhysicalspace(co.edu.icesi.ci.tallerfinal.back.model.Physicalspace physicalspace) {
		this.physicalspace = physicalspace;
	}

	public List<co.edu.icesi.ci.tallerfinal.back.model.Physicalspace> getPhysicalspaces() {
		return this.physicalspaces;
	}

	public void setPhysicalspaces(List<co.edu.icesi.ci.tallerfinal.back.model.Physicalspace> physicalspaces) {
		this.physicalspaces = physicalspaces;
	}

	public co.edu.icesi.ci.tallerfinal.back.model.Physicalspace addPhysicalspace(co.edu.icesi.ci.tallerfinal.back.model.Physicalspace physicalspace) {
	...
	public co.edu.icesi.ci.tallerfinal.back.model.Physicalspace removePhysicalspace(co.edu.icesi.ci.tallerfinal.back.model.Physicalspace physicalspace) {
