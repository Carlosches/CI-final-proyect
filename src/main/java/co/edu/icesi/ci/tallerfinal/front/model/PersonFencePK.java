...
public class PersonFencePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof co.edu.icesi.ci.tallerfinal.back.model.PersonFencePK)) {
			return false;
		}
		co.edu.icesi.ci.tallerfinal.back.model.PersonFencePK castOther = (co.edu.icesi.ci.tallerfinal.back.model.PersonFencePK)other;
		return 
